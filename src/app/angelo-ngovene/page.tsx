...
export default function AngeloNgovenePage() {
    return (
        <main className="bg-white flex-col p-4 text-black w-full min-h-screen flex justify-center items-center">
            <div className="flex flex-col flex-1 space-y-4 max-w-93.75 w-full relative md:h-auto">
                ...
                ">
                    ...
                    /> */}
                    <div data-aos="flip-left" className="shadow-xl shadow-black/50 border-2  w-3/4 absolute left-4 -bottom-1/3 bg-white/50 backdrop-blur-2xl p-4
                ...
                <div className="grid grid-cols-2 gap-2 w-full">
                    ...
                    <a data-aos="flip-up" href="#" className="flex-col border-2 p-4 col-span-2 flex justify-center items-center font-semibold"
                ...
                <div data-aos="flip-down" className="flex-1 *:grid *:place-content-center *:bg-black divide-x divide-y divide-zinc-500 text-white grid grid-cols-2">
